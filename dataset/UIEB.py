    ...
    def load_unpaired(self):
        ...
        with open(self.ann_file, 'r') as f:
            ...
            for data in data_list:
                data_infos.append({
                    "image_path": os.path.join("D:/Student_FILE/HW/UIE2025/compare_experiment/UIE/data/UIEB/raw-890", data),
                    "gt_path": os.path.join("D:/Student_FILE/HW/UIE2025/compare_experiment/UIE/data/UIEB/reference-890", data),
                    "filename": data,
                })
        return data_infos
